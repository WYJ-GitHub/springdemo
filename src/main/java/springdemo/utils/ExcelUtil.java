...
import springdemo.entity.CommonEntity;
import java.lang.reflect.*;

import springdemo.dao.BaseDao;
...
public class ExcelUtil {
    ...
    public static <E> void exportExcel(CommonEntity data, HttpServletResponse response, BaseDao dao, String[] headList,
        ...
        for (int i = 0; i < sheetCount; i++) {
            ...
            for (; m < totalPage; m++) {
                ...
                //oracle用
                data.setStartIndex(m * 5000);
                // 5000条
                data.setEndIndex(totalPage * 5000);
